...
/***************************************************************/
struct node* unionlinkedlist(struct node *START1,struct node *START2)
...
int main()
{
    ...
    traverse(&START2);
    printf("\n");
    unionlinkedlist(START1,START2);   //here we will do =>call by value<= as it dosen't commit any change
